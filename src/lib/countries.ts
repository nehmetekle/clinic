// Full country list with ISO codes and international dial codes. Used by the
// phone-number country picker and the patient "Country" dropdown.
...
// Lebanon first (clinic default), then alphabetical — used to order dropdowns.
export const COUNTRIES_ORDERED: Country[] = [
  ...COUNTRIES.filter((c) => c.iso2 === "LB"),
  ...COUNTRIES.filter((c) => c.iso2 !== "LB"),
];
